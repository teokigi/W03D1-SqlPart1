...
--Questions:
--Q01: Return ALL the data in the ‘movies’ table.
SELECT * FROM movies;
--Q02: Return ONLY the name column from the ‘people’ table
SELECT name FROM people;
--Q03: Oops! Someone spelled Krusty The Clown’s name wrong! Change it to reflect the proper spelling (Crusty should be Krusty).
UPDATE people SET name = 'Krusty the Clown' WHERE name = 'Crusty the Clown' ;
SELECT * FROM people;
--Q04: Return ONLY Homer Simpson’s name from the ‘people’ table.
SELECT name FROM people WHERE name = 'Homer Simpson';
--Q05: The cinema is showing ‘Batman Begins’, but Batman is DC, not Marvel! Delete the entry from the ‘movies’ table.
DELETE FROM movies WHERE title = 'Batman Begins';
SELECT * FROM movies;
--Q06: We forgot one of the main characters! Add Bart Simpson to the ‘people’ table
INSERT INTO people (name) VALUES ('Bart Simpson');
SELECT * FROM people;
--Q07: Eric Cartman has decided to hijack our movie evening, Remove him from the table of people.
DELETE FROM people WHERE name = 'Eric Cartman';
SELECT * FROM people;
--Q08: The cinema has just heard that they will be holding an exclusive midnight showing of ‘Avengers: Infinity War’!!
...
SELECT * FROM movies;
--Q09: The cinema would like to make the Iron Man movies a triple billing.
--     Find out the show time of “Iron Man 2”
